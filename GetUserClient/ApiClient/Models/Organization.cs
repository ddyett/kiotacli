...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<GetUserClient.ApiClient.Models.CertificateBasedAuthConfiguration>? CertificateBasedAuthConfiguration { get; set; }
#nullable restore
#else
        public List<GetUserClient.ApiClient.Models.CertificateBasedAuthConfiguration> CertificateBasedAuthConfiguration { get; set; }
#endif
...
#nullable restore
        ...
        public GetUserClient.ApiClient.Models.PartnerTenantType? PartnerTenantType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.PrivacyProfile? PrivacyProfile { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.PrivacyProfile PrivacyProfile { get; set; }
#endif
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"certificateBasedAuthConfiguration", n => { CertificateBasedAuthConfiguration = n.GetCollectionOfObjectValues<GetUserClient.ApiClient.Models.CertificateBasedAuthConfiguration>(GetUserClient.ApiClient.Models.CertificateBasedAuthConfiguration.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"privacyProfile", n => { PrivacyProfile = n.GetObjectValue<GetUserClient.ApiClient.Models.PrivacyProfile>(GetUserClient.ApiClient.Models.PrivacyProfile.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<GetUserClient.ApiClient.Models.CertificateBasedAuthConfiguration>("certificateBasedAuthConfiguration", CertificateBasedAuthConfiguration);
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.PrivacyProfile>("privacyProfile", PrivacyProfile);
