...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.ExternalConnectors.UrlMatchInfo? UrlMatchInfo { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.ExternalConnectors.UrlMatchInfo UrlMatchInfo { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"urlMatchInfo", n => { UrlMatchInfo = n.GetObjectValue<GetUserClient.ApiClient.Models.ExternalConnectors.UrlMatchInfo>(GetUserClient.ApiClient.Models.ExternalConnectors.UrlMatchInfo.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.ExternalConnectors.UrlMatchInfo>("urlMatchInfo", UrlMatchInfo);
        }
    }
}
