...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.ImplicitGrantSettings? ImplicitGrantSettings { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.ImplicitGrantSettings ImplicitGrantSettings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<GetUserClient.ApiClient.Models.RedirectUriSettings>? RedirectUriSettings { get; set; }
#nullable restore
#else
        public List<GetUserClient.ApiClient.Models.RedirectUriSettings> RedirectUriSettings { get; set; }
#endif
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"implicitGrantSettings", n => { ImplicitGrantSettings = n.GetObjectValue<GetUserClient.ApiClient.Models.ImplicitGrantSettings>(GetUserClient.ApiClient.Models.ImplicitGrantSettings.CreateFromDiscriminatorValue); } },
                {"logoutUrl", n => { LogoutUrl = n.GetStringValue(); } },
                {"@odata.type", n => { OdataType = n.GetStringValue(); } },
                {"redirectUris", n => { RedirectUris = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"redirectUriSettings", n => { RedirectUriSettings = n.GetCollectionOfObjectValues<GetUserClient.ApiClient.Models.RedirectUriSettings>(GetUserClient.ApiClient.Models.RedirectUriSettings.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.ImplicitGrantSettings>("implicitGrantSettings", ImplicitGrantSettings);
            ...
            writer.WriteCollectionOfObjectValues<GetUserClient.ApiClient.Models.RedirectUriSettings>("redirectUriSettings", RedirectUriSettings);
        }
    }
}
