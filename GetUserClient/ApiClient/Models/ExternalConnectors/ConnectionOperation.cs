...
#nullable enable
        public GetUserClient.ApiClient.Models.PublicError? Error { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.PublicError Error { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"error", n => { Error = n.GetObjectValue<GetUserClient.ApiClient.Models.PublicError>(GetUserClient.ApiClient.Models.PublicError.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.PublicError>("error", Error);
