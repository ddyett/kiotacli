...
#nullable restore
        ...
        public GetUserClient.ApiClient.Models.Importance? Importance { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.Location? Location { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.Location Location { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<GetUserClient.ApiClient.Models.Location>? Locations { get; set; }
#nullable restore
#else
        public List<GetUserClient.ApiClient.Models.Location> Locations { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.ResponseStatus? ResponseStatus { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.ResponseStatus ResponseStatus { get; set; }
#endif
        /// <summary>The sensitivity property</summary>
        public GetUserClient.ApiClient.Models.Sensitivity? Sensitivity { get; set; }
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"location", n => { Location = n.GetObjectValue<GetUserClient.ApiClient.Models.Location>(GetUserClient.ApiClient.Models.Location.CreateFromDiscriminatorValue); } },
                {"locations", n => { Locations = n.GetCollectionOfObjectValues<GetUserClient.ApiClient.Models.Location>(GetUserClient.ApiClient.Models.Location.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"responseStatus", n => { ResponseStatus = n.GetObjectValue<GetUserClient.ApiClient.Models.ResponseStatus>(GetUserClient.ApiClient.Models.ResponseStatus.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.Location>("location", Location);
            writer.WriteCollectionOfObjectValues<GetUserClient.ApiClient.Models.Location>("locations", Locations);
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.ResponseStatus>("responseStatus", ResponseStatus);
