...
#nullable enable
        public GetUserClient.ApiClient.Models.Security.Artifact? Artifact { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.Security.Artifact Artifact { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"artifact", n => { Artifact = n.GetObjectValue<GetUserClient.ApiClient.Models.Security.Artifact>(GetUserClient.ApiClient.Models.Security.Artifact.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.Security.Artifact>("artifact", Artifact);
