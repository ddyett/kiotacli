...
#nullable enable
        public List<GetUserClient.ApiClient.Models.KeyValuePair>? Arguments { get; set; }
#nullable restore
#else
        public List<GetUserClient.ApiClient.Models.KeyValuePair> Arguments { get; set; }
#endif
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"arguments", n => { Arguments = n.GetCollectionOfObjectValues<GetUserClient.ApiClient.Models.KeyValuePair>(GetUserClient.ApiClient.Models.KeyValuePair.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<GetUserClient.ApiClient.Models.KeyValuePair>("arguments", Arguments);
