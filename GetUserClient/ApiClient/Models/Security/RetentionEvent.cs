...
#nullable enable
        public GetUserClient.ApiClient.Models.IdentitySet? CreatedBy { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.IdentitySet CreatedBy { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.IdentitySet? LastModifiedBy { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.IdentitySet LastModifiedBy { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.Security.RetentionEventType? RetentionEventType { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.Security.RetentionEventType RetentionEventType { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"createdBy", n => { CreatedBy = n.GetObjectValue<GetUserClient.ApiClient.Models.IdentitySet>(GetUserClient.ApiClient.Models.IdentitySet.CreateFromDiscriminatorValue); } },
                ...
                {"lastModifiedBy", n => { LastModifiedBy = n.GetObjectValue<GetUserClient.ApiClient.Models.IdentitySet>(GetUserClient.ApiClient.Models.IdentitySet.CreateFromDiscriminatorValue); } },
                {"lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                {"lastStatusUpdateDateTime", n => { LastStatusUpdateDateTime = n.GetDateTimeOffsetValue(); } },
                {"retentionEventType", n => { RetentionEventType = n.GetObjectValue<GetUserClient.ApiClient.Models.Security.RetentionEventType>(GetUserClient.ApiClient.Models.Security.RetentionEventType.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.IdentitySet>("createdBy", CreatedBy);
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.IdentitySet>("lastModifiedBy", LastModifiedBy);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteDateTimeOffsetValue("lastStatusUpdateDateTime", LastStatusUpdateDateTime);
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.Security.RetentionEventType>("retentionEventType", RetentionEventType);
        }
    }
}
