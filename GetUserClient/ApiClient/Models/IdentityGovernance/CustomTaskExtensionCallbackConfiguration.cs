...
#nullable enable
        public List<GetUserClient.ApiClient.Models.Application>? AuthorizedApps { get; set; }
#nullable restore
#else
        public List<GetUserClient.ApiClient.Models.Application> AuthorizedApps { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"authorizedApps", n => { AuthorizedApps = n.GetCollectionOfObjectValues<GetUserClient.ApiClient.Models.Application>(GetUserClient.ApiClient.Models.Application.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<GetUserClient.ApiClient.Models.Application>("authorizedApps", AuthorizedApps);
        }
    }
}
