...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<GetUserClient.ApiClient.Models.Security.ExportFileMetadata>? ExportFileMetadata { get; set; }
#nullable restore
#else
        public List<GetUserClient.ApiClient.Models.Security.ExportFileMetadata> ExportFileMetadata { get; set; }
#endif
        ...
        public GetUserClient.ApiClient.Models.Security.ExportOptions? ExportOptions { get; set; }
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"exportFileMetadata", n => { ExportFileMetadata = n.GetCollectionOfObjectValues<GetUserClient.ApiClient.Models.Security.ExportFileMetadata>(GetUserClient.ApiClient.Models.Security.ExportFileMetadata.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<GetUserClient.ApiClient.Models.Security.ExportFileMetadata>("exportFileMetadata", ExportFileMetadata);
