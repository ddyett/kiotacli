...
#nullable enable
        public List<GetUserClient.ApiClient.Models.ExternalConnectors.Acl>? Acl { get; set; }
#nullable restore
#else
        public List<GetUserClient.ApiClient.Models.ExternalConnectors.Acl> Acl { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.ExternalConnectors.Properties? Properties { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.ExternalConnectors.Properties Properties { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"acl", n => { Acl = n.GetCollectionOfObjectValues<GetUserClient.ApiClient.Models.ExternalConnectors.Acl>(GetUserClient.ApiClient.Models.ExternalConnectors.Acl.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"properties", n => { Properties = n.GetObjectValue<GetUserClient.ApiClient.Models.ExternalConnectors.Properties>(GetUserClient.ApiClient.Models.ExternalConnectors.Properties.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<GetUserClient.ApiClient.Models.ExternalConnectors.Acl>("acl", Acl);
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.ExternalConnectors.Properties>("properties", Properties);
        }
    }
}
