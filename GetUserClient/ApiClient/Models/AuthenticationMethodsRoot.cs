...
#nullable enable
        public List<GetUserClient.ApiClient.Models.UserRegistrationDetails>? UserRegistrationDetails { get; set; }
#nullable restore
#else
        public List<GetUserClient.ApiClient.Models.UserRegistrationDetails> UserRegistrationDetails { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"userRegistrationDetails", n => { UserRegistrationDetails = n.GetCollectionOfObjectValues<GetUserClient.ApiClient.Models.UserRegistrationDetails>(GetUserClient.ApiClient.Models.UserRegistrationDetails.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<GetUserClient.ApiClient.Models.UserRegistrationDetails>("userRegistrationDetails", UserRegistrationDetails);
        }
    }
}
