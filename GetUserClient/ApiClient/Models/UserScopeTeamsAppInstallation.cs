...
#nullable enable
        public GetUserClient.ApiClient.Models.Chat? Chat { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.Chat Chat { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"chat", n => { Chat = n.GetObjectValue<GetUserClient.ApiClient.Models.Chat>(GetUserClient.ApiClient.Models.Chat.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.Chat>("chat", Chat);
        }
    }
}
