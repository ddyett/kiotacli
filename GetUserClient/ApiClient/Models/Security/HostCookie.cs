...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.Security.Host? Host { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.Security.Host Host { get; set; }
#endif
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"host", n => { Host = n.GetObjectValue<GetUserClient.ApiClient.Models.Security.Host>(GetUserClient.ApiClient.Models.Security.Host.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.Security.Host>("host", Host);
