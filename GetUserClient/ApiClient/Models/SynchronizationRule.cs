...
#nullable enable
        public GetUserClient.ApiClient.Models.ContainerFilter? ContainerFilter { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.ContainerFilter ContainerFilter { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.GroupFilter? GroupFilter { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.GroupFilter GroupFilter { get; set; }
#endif
...
#nullable restore
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"containerFilter", n => { ContainerFilter = n.GetObjectValue<GetUserClient.ApiClient.Models.ContainerFilter>(GetUserClient.ApiClient.Models.ContainerFilter.CreateFromDiscriminatorValue); } },
                {"editable", n => { Editable = n.GetBoolValue(); } },
                {"groupFilter", n => { GroupFilter = n.GetObjectValue<GetUserClient.ApiClient.Models.GroupFilter>(GetUserClient.ApiClient.Models.GroupFilter.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.ContainerFilter>("containerFilter", ContainerFilter);
            writer.WriteBoolValue("editable", Editable);
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.GroupFilter>("groupFilter", GroupFilter);
