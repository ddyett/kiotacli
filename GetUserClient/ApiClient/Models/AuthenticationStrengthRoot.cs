...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<GetUserClient.ApiClient.Models.AuthenticationMethodModes?>? Combinations { get; set; }
#nullable restore
#else
        public List<GetUserClient.ApiClient.Models.AuthenticationMethodModes?> Combinations { get; set; }
#endif
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"combinations", n => { Combinations = n.GetCollectionOfEnumValues<GetUserClient.ApiClient.Models.AuthenticationMethodModes>()?.ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfEnumValues<GetUserClient.ApiClient.Models.AuthenticationMethodModes>("combinations", Combinations);
