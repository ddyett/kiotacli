...
#nullable restore
        ...
        public GetUserClient.ApiClient.Models.FederatedIdpMfaBehavior? FederatedIdpMfaBehavior { get; set; }
...
#nullable restore
        ...
        public GetUserClient.ApiClient.Models.PromptLoginBehavior? PromptLoginBehavior { get; set; }
        /// <summary>Provides status and timestamp of the last update of the signing certificate.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.SigningCertificateUpdateStatus? SigningCertificateUpdateStatus { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.SigningCertificateUpdateStatus SigningCertificateUpdateStatus { get; set; }
#endif
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"signingCertificateUpdateStatus", n => { SigningCertificateUpdateStatus = n.GetObjectValue<GetUserClient.ApiClient.Models.SigningCertificateUpdateStatus>(GetUserClient.ApiClient.Models.SigningCertificateUpdateStatus.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.SigningCertificateUpdateStatus>("signingCertificateUpdateStatus", SigningCertificateUpdateStatus);
