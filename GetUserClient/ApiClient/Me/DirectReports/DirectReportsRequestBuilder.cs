...
using System;
namespace GetUserClient.ApiClient.Me.DirectReports {
    /// <summary>
    ...
    public class DirectReportsRequestBuilder : BaseCliRequestBuilder {
        ...
        public DirectReportsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/me/directReports{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The users and contacts that report to the user. (The users and contacts that have their manager property set to this user.) Read-only. Nullable. Supports $expand.
        /// </summary>
