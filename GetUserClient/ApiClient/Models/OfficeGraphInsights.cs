...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<GetUserClient.ApiClient.Models.Trending>? Trending { get; set; }
#nullable restore
#else
        public List<GetUserClient.ApiClient.Models.Trending> Trending { get; set; }
#endif
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"trending", n => { Trending = n.GetCollectionOfObjectValues<GetUserClient.ApiClient.Models.Trending>(GetUserClient.ApiClient.Models.Trending.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<GetUserClient.ApiClient.Models.Trending>("trending", Trending);
