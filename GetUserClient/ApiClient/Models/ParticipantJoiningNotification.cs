...
#nullable enable
        public GetUserClient.ApiClient.Models.Call? Call { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.Call Call { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"call", n => { Call = n.GetObjectValue<GetUserClient.ApiClient.Models.Call>(GetUserClient.ApiClient.Models.Call.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.Call>("call", Call);
        }
    }
}
