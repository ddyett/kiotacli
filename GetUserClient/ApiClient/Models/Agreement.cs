...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.TermsExpiration? TermsExpiration { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.TermsExpiration TermsExpiration { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"termsExpiration", n => { TermsExpiration = n.GetObjectValue<GetUserClient.ApiClient.Models.TermsExpiration>(GetUserClient.ApiClient.Models.TermsExpiration.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.TermsExpiration>("termsExpiration", TermsExpiration);
