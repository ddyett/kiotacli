...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.Json? Layout { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.Json Layout { get; set; }
#endif
...
#nullable restore
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"layout", n => { Layout = n.GetObjectValue<GetUserClient.ApiClient.Models.Json>(GetUserClient.ApiClient.Models.Json.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.Json>("layout", Layout);
