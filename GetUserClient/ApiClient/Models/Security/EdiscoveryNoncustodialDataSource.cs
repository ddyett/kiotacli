...
#nullable enable
        public GetUserClient.ApiClient.Models.Security.DataSource? DataSource { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.Security.DataSource DataSource { get; set; }
#endif
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"dataSource", n => { DataSource = n.GetObjectValue<GetUserClient.ApiClient.Models.Security.DataSource>(GetUserClient.ApiClient.Models.Security.DataSource.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.Security.DataSource>("dataSource", DataSource);
