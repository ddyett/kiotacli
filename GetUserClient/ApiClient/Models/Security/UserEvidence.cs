...
#nullable enable
        public GetUserClient.ApiClient.Models.Security.UserAccount? UserAccount { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.Security.UserAccount UserAccount { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"userAccount", n => { UserAccount = n.GetObjectValue<GetUserClient.ApiClient.Models.Security.UserAccount>(GetUserClient.ApiClient.Models.Security.UserAccount.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.Security.UserAccount>("userAccount", UserAccount);
        }
    }
}
