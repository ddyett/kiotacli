...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.CallRecords.FailureInfo? FailureInfo { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.CallRecords.FailureInfo FailureInfo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<GetUserClient.ApiClient.Models.CallRecords.Media>? Media { get; set; }
#nullable restore
#else
        public List<GetUserClient.ApiClient.Models.CallRecords.Media> Media { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"failureInfo", n => { FailureInfo = n.GetObjectValue<GetUserClient.ApiClient.Models.CallRecords.FailureInfo>(GetUserClient.ApiClient.Models.CallRecords.FailureInfo.CreateFromDiscriminatorValue); } },
                {"media", n => { Media = n.GetCollectionOfObjectValues<GetUserClient.ApiClient.Models.CallRecords.Media>(GetUserClient.ApiClient.Models.CallRecords.Media.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.CallRecords.FailureInfo>("failureInfo", FailureInfo);
            writer.WriteCollectionOfObjectValues<GetUserClient.ApiClient.Models.CallRecords.Media>("media", Media);
