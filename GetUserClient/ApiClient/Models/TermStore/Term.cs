...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<GetUserClient.ApiClient.Models.KeyValue>? Properties { get; set; }
#nullable restore
#else
        public List<GetUserClient.ApiClient.Models.KeyValue> Properties { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.TermStore.Set? Set { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.TermStore.Set Set { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"properties", n => { Properties = n.GetCollectionOfObjectValues<GetUserClient.ApiClient.Models.KeyValue>(GetUserClient.ApiClient.Models.KeyValue.CreateFromDiscriminatorValue)?.ToList(); } },
                {"relations", n => { Relations = n.GetCollectionOfObjectValues<Relation>(Relation.CreateFromDiscriminatorValue)?.ToList(); } },
                {"set", n => { Set = n.GetObjectValue<GetUserClient.ApiClient.Models.TermStore.Set>(GetUserClient.ApiClient.Models.TermStore.Set.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<GetUserClient.ApiClient.Models.KeyValue>("properties", Properties);
            writer.WriteCollectionOfObjectValues<Relation>("relations", Relations);
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.TermStore.Set>("set", Set);
        }
    }
}
