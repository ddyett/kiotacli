...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.IdentitySet? Organizer { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.IdentitySet Organizer { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<GetUserClient.ApiClient.Models.IdentitySet>? Participants { get; set; }
#nullable restore
#else
        public List<GetUserClient.ApiClient.Models.IdentitySet> Participants { get; set; }
#endif
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"organizer", n => { Organizer = n.GetObjectValue<GetUserClient.ApiClient.Models.IdentitySet>(GetUserClient.ApiClient.Models.IdentitySet.CreateFromDiscriminatorValue); } },
                {"participants", n => { Participants = n.GetCollectionOfObjectValues<GetUserClient.ApiClient.Models.IdentitySet>(GetUserClient.ApiClient.Models.IdentitySet.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.IdentitySet>("organizer", Organizer);
            writer.WriteCollectionOfObjectValues<GetUserClient.ApiClient.Models.IdentitySet>("participants", Participants);
