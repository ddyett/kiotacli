...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.EmailAddress? EmailAddress { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.EmailAddress EmailAddress { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"emailAddress", n => { EmailAddress = n.GetObjectValue<GetUserClient.ApiClient.Models.EmailAddress>(GetUserClient.ApiClient.Models.EmailAddress.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.EmailAddress>("emailAddress", EmailAddress);
