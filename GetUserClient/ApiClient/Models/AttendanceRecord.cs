...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.Identity? Identity { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.Identity Identity { get; set; }
#endif
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"identity", n => { Identity = n.GetObjectValue<GetUserClient.ApiClient.Models.Identity>(GetUserClient.ApiClient.Models.Identity.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.Identity>("identity", Identity);
