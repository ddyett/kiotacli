...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.Printer? Printer { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.Printer Printer { get; set; }
#endif
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"printer", n => { Printer = n.GetObjectValue<GetUserClient.ApiClient.Models.Printer>(GetUserClient.ApiClient.Models.Printer.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.Printer>("printer", Printer);
