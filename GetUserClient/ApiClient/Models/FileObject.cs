...
namespace GetUserClient.ApiClient.Models {
    public class FileObject : IParsable {
        /// <summary>Hashes of the file&apos;s binary content, if available. Read-only.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GetUserClient.ApiClient.Models.Hashes? Hashes { get; set; }
#nullable restore
#else
        public GetUserClient.ApiClient.Models.Hashes Hashes { get; set; }
#endif
...
#nullable restore
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"hashes", n => { Hashes = n.GetObjectValue<GetUserClient.ApiClient.Models.Hashes>(GetUserClient.ApiClient.Models.Hashes.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GetUserClient.ApiClient.Models.Hashes>("hashes", Hashes);
